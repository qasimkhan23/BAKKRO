...
import profileImage2 from "./ProfileImage2.svg";
...
import bookingDetails from "./BookingDetails.svg";
...
export const ProvicyPolicy = privacyPolicy;
export const HelpSupport = helpSupport;
export const Logout = logout;

export const Seperator = seperator;
export const CirclePlus = circlePlus;
export const EmptyCheckbox = emptyCheckbox;
...
export const ProfileImage2 = profileImage2;
export const Right = right;
export const Profile3 = profile3;
